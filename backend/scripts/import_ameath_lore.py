"""Rebuild Ameath character lore in ChromaDB from curated chunks."""
...
LORE_FILE = WORKSPACE_DIR / "docs" / "characters" / "Ameath" / "ameath.txt"
...
def main() -> None:
    ...
    result = vector_store.similarity_search("爱弥斯是谁", k=3)
